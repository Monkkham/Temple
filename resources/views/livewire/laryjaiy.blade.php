...
<div>
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="text-danger"><i class="fa fa-book"></i> ບັນທຶກລາຍຈ່າຍ</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <div class="row">
                    <div class="col-md-6">
                      <a wire:click="create" href="javascript:void(0)" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> ເພີ່ມໃຫມ່</a>
                    </div>
                  </div>
                </div>
                <div class="card-body">
