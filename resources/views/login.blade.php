...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b><i style="font-size: 40px" class="fa fa-dharmachakra text-warning"></i> ວັດອຳພາວັນ <i style="font-size: 40px" class="fa fa-dharmachakra text-warning"></i></b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="{{route('store')}}" method="post">
        ...
        @if(count($errors)>0)
            <div class="card-body">
                <div class="alert alert-danger alert-dismissible">
                  ...
                  <i class="icon fas fa-ban"> ຂໍ້ຜິດພາດ</i></br>
        ...
        <div class="input-group mb-3">
          <input type="email" name="email" class="form-control" value="admin@gmail.com" placeholder="ອີເມວ:">
